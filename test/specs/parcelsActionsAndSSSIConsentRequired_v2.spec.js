...
describe('Parcels V2 endpoint', () => {
  it('should validate version2 parcels actions, SSSI consent required and available area from CSV input', async () => {
    const dataFile =
      './test/data/parcelsActionsAndSSSIConsentRequiredData_v2.csv'
