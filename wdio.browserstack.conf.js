...
export const config = {
  ...
  baseUrl: `https://land-grants-api-tests.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `land-grants-api-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `land-grants-api-tests-${process.env.ENVIRONMENT}`
        },
